...
Right-click `Deloitte_github_project.zip` → **Extract All**. Open the extracted folder until you can see `app.py`, `requirements.txt`, and `START_WINDOWS.bat` together. Do not run the project from inside the ZIP.
